...
* eGovFrame 표준 프레임워크 기반으로 구성되어 있습니다
* MyBatis Generator로 Mapper 자동 생성 구조를 사용합니다
* 이미지는 TEMP 상태로 먼저 저장되고, 게시글 등록/수정 시 STORE로 전환됩니다
* 이미지(TEMP 상태로 방치된 이미지) 정리 로직은 추후 배치 작업으로 구현 예정입니다
